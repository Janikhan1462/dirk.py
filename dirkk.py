...
\033[1;91m☞ Auther     : DIRK HACKER
\033[1;92m☞ WhatsApp   : No NUMBER
\033[1;95m☞ YouTube    : No
...
def menu():
	...
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' DIRK CLONING')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update DIRK  Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' DIRK HACKER WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num DIRK✓')
	    psb('WellCome To DIRK_HACKER)
	    psb('Congratulations DIRK Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel DIRK HACKER✓')
